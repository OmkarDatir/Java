...
public class TaskManager {
	...
	private static void checkUpdateStatus(int taskID, String next, List<Task> taskList) {
	...
	private static void checkAvailable(int taskID, List<Task> taskList) {
		// TODO Auto-generated method stub
		
	}

	private static Task validateTask(String taskN, String description, String dated) {
		// TODO Auto-generated method stub
		return null;
	}
